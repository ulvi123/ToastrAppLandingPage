...
export function Cta() {
  return (
    <div className='w-full rounded-[16px] bg-gradient-to-br from-red-800 via-yellow-600 to-yellow-500 py-[56px] px-[33px] text-center lg:my-[60px] lg:px-[320px] lg:py-[90px]'>
